...
<template>
  <div flex-1>
    ...
    <c-modal v-model:open="isModalOpen" class="palette-modal" shadow-xl important:max-w-650px important:pa-12px important:mt-12 sm:important:mt-16 @keydown="handleKeydown">
